...
int main(void) {
    ...
    b_i = 1;
    c_i = 0;
    const int32_t WRAP_MASK = 0x7FF; //actually mod 2048 but no div
    for(int i = 0; i < 100000; i++){
        a_i = (a_i * 2) & WRAP_MASK;   // Wrap around after 2048
        b_i = (b_i * 3) & WRAP_MASK;
        c_i += (a_i * b_i) & WRAP_MASK;
        //printf("C = %f\n", c_f);
    }
    time2 =time_us_64();
    cycles2 = cycleCount();
    ...
    printf("Integer Multiplication Results: \n");
